...
const QMetaObject OpeDB::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_OpeDB.data,
      qt_meta_data_OpeDB,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OpeDB::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OpeDB.stringdata0))
        return static_cast<void*>(const_cast< OpeDB*>(this));
