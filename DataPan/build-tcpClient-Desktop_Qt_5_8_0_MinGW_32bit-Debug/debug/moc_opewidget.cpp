...
const QMetaObject OpeWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_OpeWidget.data,
      qt_meta_data_OpeWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *OpeWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OpeWidget.stringdata0))
        return static_cast<void*>(const_cast< OpeWidget*>(this));
