...
void PrivateChat::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        PrivateChat *_t = static_cast<PrivateChat *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
const QMetaObject PrivateChat::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PrivateChat.data,
      qt_meta_data_PrivateChat,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PrivateChat::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PrivateChat.stringdata0))
        return static_cast<void*>(const_cast< PrivateChat*>(this));
