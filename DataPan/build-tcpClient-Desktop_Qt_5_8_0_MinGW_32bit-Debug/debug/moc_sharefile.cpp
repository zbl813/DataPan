...
const QMetaObject ShareFile::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_ShareFile.data,
      qt_meta_data_ShareFile,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ShareFile::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ShareFile.stringdata0))
        return static_cast<void*>(const_cast< ShareFile*>(this));
